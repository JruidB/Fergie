(function(window){
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            ...
            ctx.fillText("Eres muy especial", 26, 186);
            ctx.restore();
        },
        clear: function() {
            var ctx = this.tree.ctx, cirle = this.cirle;
    ...
    Tree.prototype = {
        ...
        jump: function() {
            ...
            // --- MODIFICACIÓN PARA OTOÑO NATURAL ---
            // Hemos cambiado el límite de 3 a 15.
            // Esto permite hasta 15 corazones cayendo simultáneamente.
            if ((blooms.length && blooms.length < 15) || !blooms.length) {
                ...
                // Mantenemos la generación suave: solo 1 o 2 a la vez.
                // Esto evita la "explosión" de corazones y crea un flujo constante.
   ...
   Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        ...
        var colorType = random(1, 3);
        var r, g, b;
        if (colorType === 1) { 
            r = random(160, 200); g = 0; b = random(0, 10);
        } else if (colorType === 2) { 
            r = 255; g = random(0, 50); b = random(0, 50);
        } else { 
            r = 255; g = random(100, 180); b = random(120, 180);
        }
